...
export default function ManuPage() {
  ...
  const t = {
    about: tr(lang, { en: 'About Manu', de: 'Über Manu', es: 'Sobre Manu' }),
    portfolio: tr(lang, { en: 'Manu Portfolio', de: 'Manu Portfolio', es: 'Portafolio de Manu' }),
