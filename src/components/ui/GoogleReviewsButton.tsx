import { GoogleReviewsButtonProps } from '@/types';

export default function GoogleReviewsButton({ onClick, className = "" }: GoogleReviewsButtonProps) {
  return (
    <button
      onClick={onClick}
    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <span className="text-xs text-gray-600">Read our reviews</span>
      </div>
    </button>
  );
}
