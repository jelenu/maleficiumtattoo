  ...
  const classes = cx(
    ...
    fluidMobile
      ? {
          ...
          aboutBody: "text-[clamp(0.6rem,1.6vh,2.5rem)]",
          stylesTitle: "text-[clamp(1.125rem,3vh,1.75rem)]",
          stylesBody: "text-[clamp(0.6rem,1.6vh,2.5rem)]",
    ...
    fluidTablet
      ? {
          ...
          aboutBody: "md:text-[clamp(0.9rem,1.5vh,1.3rem)]",
          stylesTitle: "md:text-[clamp(1.5rem,3vh,2.6rem)]",
          stylesBody: "md:text-[clamp(0.9rem,1.5vh,1.3rem)]",
    ...
    fluidDesktop
      ? {
          ...
          aboutBody: "xl:text-[clamp(1.0625rem,1.15vmin,1.3rem)]",
          stylesTitle: "xl:text-[clamp(1.5rem,3.4vmin,2.5rem)]",
          stylesBody: "xl:text-[clamp(1.0625rem,1.15vmin,1.3rem)]",
