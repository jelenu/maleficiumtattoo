    ...
    artists: [
      {
        ...
        description: t({
          ...
          de: 'Alexis stammt ursprünglich aus Barcelona und tätowiert seit über 10 Jahren. Sein Schwerpunkt liegt auf Blackwork mit starken Kontrasten sowie der Kombination aus dicken und feinen Linien, ergänzt durch Whip Shading. Seine Arbeiten sind klar, kraftvoll und langlebig – besonders geeignet für Narben- oder Cover-up-Projekte. Er ist außerdem auf Tätowierungen im Intimbereich spezialisiert. Jedes Tattoo wird individuell nach Kund:innenwunsch entworfen und an Körper und Persönlichkeit angepasst.',
      ...
      },
      {
        ...
        description: t({
          ...
          de: 'Christoph stammt aus Ybbs an der Donau und bringt 15 Jahre Erfahrung mit. Sein Schwerpunkt liegt im Bereich New School Color. Kräftige Linien, leuchtende Farben, eigenständige Charaktere und dynamische Kompositionen zeichnen seine Arbeiten aus. Er realisiert vor allem großflächige Projekte mit starker visueller Präsenz.',
      ...
      },
      {
        ...
        description: t({
          ...
          de: 'Juani stammt aus Málaga und betreibt ein eigenes Studio in Zaragoza. Mit über 15 Jahren Erfahrung ist er auf American Traditional spezialisiert. Seine Tattoos zeichnen sich durch kräftige Linien und intensive Farben aus, die sich vom europäischen Traditional-Stil unterscheiden.',
